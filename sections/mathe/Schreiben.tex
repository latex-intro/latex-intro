...
\medskip\pause
Antwort: Das $\in$-Symbol erhält man über die Befehle \verb+\in+ ($\in$) und \verb+\ni+ ($\ni$)
...
\]
Mit \cmd{overset}\marg{Text}\marg{Operator} lässt sich außerdem auf andere Pfeile Beschriftung setzen: 
\[
